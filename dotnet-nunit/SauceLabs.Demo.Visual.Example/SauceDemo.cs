...
public class SauceDemo
{
    ...
    [Test]
    public async Task SauceDemo_CheckInventory_ShouldAddBackpackToCartBis()
    {
        Driver.Navigate().GoToUrl("https://www.saucedemo.com");
        ...
        await VisualClient.VisualCheck("Login Page - bis");
        ...
        await VisualClient.VisualCheck("Inventory Page - bis");
    ...
    [Test]
    public async Task SauceDemo_CheckInventory_ShouldAddBackpackToCartThird()
    {
        Driver.Navigate().GoToUrl("https://www.saucedemo.com");
        ...
        await VisualClient.VisualCheck("Login Page - third");
        ...
        await VisualClient.VisualCheck("Inventory Page - third");
